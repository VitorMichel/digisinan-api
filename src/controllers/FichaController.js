...
const CreatePdf = require('../testePdf');
const GerarPdf = require('../createPdf');
    ...
    async postAddFicha(request, response, next)
    {
        ...
        let removerNomes = (str, arr) => {
          ...
          const dados = request.body;
            ...
            console.log('Email subject:' + assuntoEmail);
            let nomeArquivo = 'FICHA SRAG - ' + dados.patientData.patientCpf;
            ...
            pdf.text('RS',76, 153); // campo 03 uf                                                                                        //TODO
          
            pdf.text('Santa Cruz do Sul - Rio Grande do Sul', 182, 153, {width: 215}); //campo 04 cidade                                  //TODO
            ...
            pdf.text('Engenheiro de Software', 137, 347, {width: 160}); // campo 20 ocupação                                              //TODO
            ...
            pdf.text('Brasil', 466, 453, {width: 123}); // campo 31 país
            ...
            pdf.text('RS',490, 77); // campo 47 uf                                                                                        //TODO
            pdf.text('Porto Alegre', 203, 92, {width: 182}); // campo 48 município internação                                             //TODO
            ...
            pdf.text('Gumercindo da Silva Santos', 67, 767, {width: 320}); // campo 82 profissional                                                               //TODO
          
            pdf.text(dados.finalData.healthProfessionalResponsibleForFillingOutTheForm, 470, 767); // campo 83 conselho profissional
          
            pdf.image(caminhoAssinatura, 250, 750, {height: 35, width: 75});
            ...
            stream.on('end', function() {
              response.json({ficha: pdfEmBase64, assunto: assuntoEmail});
            });
        ...
        // let ficha = GerarPdf.createSamplePdf(request.body, response);
        // console.log(ficha);

        // return response.json({ficha: ficha});
    }
}