...
module.exports = {
  ...
  async postAddFile(request, response, next) {
    ...
    // else if (data.finalData.healthProfessionalResponsibleForFillingOutTheForm === '654321')
    //   signaturePath = './template/assinatura2.jpg'
    // else if (data.finalData.healthProfessionalResponsibleForFillingOutTheForm === '789456')
    //   signaturePath = './template/assinatura3.jpg';
